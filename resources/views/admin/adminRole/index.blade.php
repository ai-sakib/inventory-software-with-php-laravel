...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Admin Roles &nbsp;<a onclick="addPage('admin-roles','Admin Role')" class="btn btn-sm bg-success"><i class="fas fa-plus"></i> Add</a></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                ...
                <tbody>
                  @if(isset($adminRoles[0]))
                   @foreach($adminRoles as $key => $value)
                  <tr id="tr-{{$value->id}}">
                    <td>{{ $key+1 }}</td>
                    <td>
                      @if($value->id != 1)
                        <a onclick="editPage('admin-roles','{{ $value->id }}','Admin Role')"  title="Edit" class="btn bg-primary btn-xs"><i class="fas fa-edit" aria-hidden="true"></i></a>
