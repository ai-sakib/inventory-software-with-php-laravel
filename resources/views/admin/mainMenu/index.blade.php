...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Main Menu &nbsp;<a onclick="addPage('main-menu','Main Menu')" class="btn btn-sm bg-success"><i class="fas fa-plus"></i> Add</a></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
                ...
                <tbody>
                  @if(isset($mainMenus[0]))
                    ...
                    <tr id="tr-{{$value->id}}">
                      ...
                      <td>
                        <a onclick="editPage('main-menu','{{ $value->id }}', 'Main Menu')"  title="Edit" class="btn bg-primary btn-xs"><i class="fas fa-edit" aria-hidden="true"></i></a>
