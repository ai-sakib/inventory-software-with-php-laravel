<div class="header-top-area">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: cadetblue;">
                                ...
                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                            ...
                                            <ul class="message-menu">
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            {{-- <img src="{{ url('public') }}/img/contact/.jpg" alt=""> --}}
                                                        </div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            <img src="{{ url('public') }}/img/contact/4.jpg" alt="">
                                                        </div>
                                                        <div class="message-content">
                                                            <span class="message-date">16 Sept</span>
                                                            <h2>Sulaiman din</h2>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            <img src="{{ url('public') }}/img/contact/3.jpg" alt="">
                                                        </div>
                                                        <div class="message-content">
                                                            <span class="message-date">16 Sept</span>
                                                            <h2>Victor Jara</h2>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            <img src="{{ url('public') }}/img/contact/2.jpg" alt="">
                                                        </div>
                                                        <div class="message-content">
                                                            <span class="message-date">16 Sept</span>
                                                            <h2>Victor Jara</h2>
                                    ...
                                    <li class="nav-item">
                                        <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                            ...
                                            <span data-toggle="modal" class="admin-name">{{ \Auth::user()->name }}</span>
                                            <i class="fa fa-angle-down adminpro-icon adminpro-down-arrow"></i>
                                        </a>
                                        <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                            <li><a onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" href="{{ route('logout') }}"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                            </li>
                                                            ...
                                                            <ul class="notes-menu-list">
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="notes-list-flow">
                                                                            <div class="notes-img">
                                                                                <img src="{{ url('public') }}/img/contact/1.jpg" alt="" />
                                                                            </div>
                                                                            <div class="notes-content">
                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                <span>Yesterday 2:45 pm</span>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer" id="quickViewModalFooter">
          <button type="button" class="btn btn-danger" data-dismiss="modal" id="quickViewModalClose">Close</button>
        </div>
      </div>
    </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <div class="row">
            <div class="col-md-12 col-md-12 col-sm-6 col-xs-12">
